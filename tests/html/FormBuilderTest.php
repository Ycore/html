...
use Ycore\Html\Styles\NoStyle;
use Ycore\Html\Styles\Bootstrap4;

use Ycore\Html\FormBuilder;
...
class FormBuilderTest extends TestCase
{
    ...
    {
        // Remember to avoid:  Call to a member function make() on null
        parent::setUp();
    ...
    */
    public function setUp()
    {
        ...
        $this->htmlNoStyle = new HtmlBuilder(new NoStyle());
        $this->formNoStyle = new FormBuilder($this->urlGenerator, $this->htmlNoStyle, 'abc');

        $this->htmlBoot4 = new HtmlBuilder(new Bootstrap4());
        $this->formBoot4 = new FormBuilder($this->urlGenerator, $this->htmlBoot4, 'abc');
    }
    ...
    */
    ...
    public function testOpeningForm()
    {
        ...
        $form1 = $this->formNoStyle->open(['method' => 'GET']);
        $form2 = $this->formNoStyle->open(['method' => 'POST', 'class' => 'form', 'id' => 'id-form']);
        $form3 = $this->formNoStyle->open(['method' => 'GET', 'accept-charset' => 'UTF-16']);
        $form4 = $this->formNoStyle->open(['method' => 'GET', 'accept-charset' => 'UTF-16', 'files' => true]);
        $form5 = $this->formNoStyle->open(['method' => 'PUT']);

        $this->assertEquals('<form method="GET" action="http://localhost/foo" accept-charset="UTF-8">', $form1);
        $this->assertEquals('<form method="POST" action="http://localhost/foo" accept-charset="UTF-8" class="form" id="id-form"><input type="hidden" name="_token" value="abc" />', $form2);
        ...
        $this->assertEquals('<form method="POST" action="http://localhost/foo" accept-charset="UTF-8"><input type="hidden" name="_method" value="PUT" /><input type="hidden" name="_token" value="abc" />', $form5);

    }

    public function testClosingForm()
    {
        $this->assertEquals('</form>', $this->formNoStyle->close());
    }

    public function testFormLabel()
    {
        $form1 = (string) $this->formNoStyle->label(['for' => 'foo'], 'Foobar');
        $form2 = (string) $this->formNoStyle->label(['for' => 'foo', 'class' => 'control-label'], 'Foobar');
...
/*
    ...
    {
        $form1 = $this->formNoStyle->input('text', 'foo');
        $form2 = $this->formNoStyle->input('text', 'foo', 'foobar');
        $form3 = $this->formNoStyle->input('date', 'foobar', null, ['class' => 'span2']);
    ...
    {
        $this->formNoStyle->setSessionStore($session = m::mock('Illuminate\Session\Store'));

        $session->shouldReceive('getOldInput')->never();

        $form1 = $this->formNoStyle->password('password');
    ...
    public function testFilesNotFilled()
    {
        ...
        $form = $this->formNoStyle->file('img');
    ...
    {
        $form1 = $this->formNoStyle->input('text', 'foo');
        $form2 = $this->formNoStyle->text('foo');
        $form3 = $this->formNoStyle->text('foo', 'foobar');
        $form4 = $this->formNoStyle->text('foo', null, ['class' => 'span2']);
    ...
    public function testFormTextRepopulation()
    {
        ...
        $input = $this->formNoStyle->text('name.with.dots', 'default value');
        ...
        $input = $this->formNoStyle->text('text[key][sub]', 'default value');
        ...
        $input1 = $this->formNoStyle->text('relation[key]');

        $this->setModel($model, false);
        $input2 = $this->formNoStyle->text('relation[key]');
    ...
    {
        $this->formNoStyle->model(['user' => (object) ['password' => 'apple']]);
        $input = $this->formNoStyle->text('user[password]');
        $this->assertEquals('<input name="user[password]" type="text" value="apple">', $input);

        $this->formNoStyle->model((object) ['letters' => ['a', 'b', 'c']]);
        $input = $this->formNoStyle->text('letters[1]');
        $this->assertEquals('<input name="letters[1]" type="text" value="b">', $input);
    }

    public function testFormPassword()
    {
        $form1 = $this->formNoStyle->password('foo');
        $form2 = $this->formNoStyle->password('foo', ['class' => 'span2']);
    ...
    {
        $form1 = $this->formNoStyle->hidden('foo');
        $form2 = $this->formNoStyle->hidden('foo', 'foobar');
        $form3 = $this->formNoStyle->hidden('foo', null, ['class' => 'span2']);
    ...
    {
        $form1 = $this->formNoStyle->email('foo');
        $form2 = $this->formNoStyle->email('foo', 'foobar');
        $form3 = $this->formNoStyle->email('foo', null, ['class' => 'span2']);
    ...
    {
        $form1 = $this->formNoStyle->tel('foo');
        $form2 = $this->formNoStyle->tel('foo', 'foobar');
        $form3 = $this->formNoStyle->tel('foo', null, ['class' => 'span2']);
    ...
    {
        $form1 = $this->formNoStyle->number('foo');
        $form2 = $this->formNoStyle->number('foo', 1);
        $form3 = $this->formNoStyle->number('foo', null, ['class' => 'span2']);
    ...
    {
        $form1 = $this->formNoStyle->date('foo');
        $form2 = $this->formNoStyle->date('foo', '2015-02-20');
        $form3 = $this->formNoStyle->date('foo', \Carbon\Carbon::now());
        $form4 = $this->formNoStyle->date('foo', null, ['class' => 'span2']);
    ...
    {
        $form1 = $this->formNoStyle->time('foo');
        $form2 = $this->formNoStyle->time('foo', \Carbon\Carbon::now()->format('H:i'));
        $form3 = $this->formNoStyle->time('foo', null, ['class' => 'span2']);
    ...
    {
        $form1 = $this->formNoStyle->file('foo');
        $form2 = $this->formNoStyle->file('foo', ['class' => 'span2']);
    ...
    {
        $form1 = $this->formNoStyle->textarea('foo');
        $form2 = $this->formNoStyle->textarea('foo', 'foobar');
        $form3 = $this->formNoStyle->textarea('foo', null, ['class' => 'span2']);
        $form4 = $this->formNoStyle->textarea('foo', null, ['size' => '60x15']);
    ...
    {
        $select = $this->formNoStyle->select(
      'size',
      ['L' => 'Large', 'S' => 'Small']
    );
      ...
      ['class' => 'class-name', 'id' => 'select-id']
        ...
        $this->formNoStyle->label('select-name-id');
        $select = $this->formNoStyle->select(
      'select-name-id',
      [],
      null,
    ...
    public function testFormSelectRepopulation()
    {
        ...
        $select = $this->formNoStyle->select('size', $list, 'S');
        ...
        $select = $this->formNoStyle->select('size[multi][]', $list, 'M', ['multiple' => 'multiple']);
        ...
        $select = $this->formNoStyle->select('size[key]', $list);
    ...
    {
        $select1 = $this->formNoStyle->selectYear('year', 2000, 2020);
        $select2 = $this->formNoStyle->selectYear('year', 2000, 2020, null, ['id' => 'foo']);
        $select3 = $this->formNoStyle->selectYear('year', 2000, 2020, '2000');
    ...
    {
        $range = $this->formNoStyle->selectRange('dob', 1900, 2013);
    ...
    {
        $month1 = $this->formNoStyle->selectMonth('month');
        $month2 = $this->formNoStyle->selectMonth('month', '1');
        $month3 = $this->formNoStyle->selectMonth('month', null, ['id' => 'foo']);
    ...
    public function testFormCheckbox()
    {
        ...
        $form1 = $this->formNoStyle->input('checkbox', 'foo');
        $form2 = $this->formNoStyle->checkbox('foo');
        $form3 = $this->formNoStyle->checkbox('foo', 'foobar', true);
        $form4 = $this->formNoStyle->checkbox('foo', 'foobar', false, ['class' => 'span2']);
    ...
    public function testFormCheckboxRepopulation()
    {
        ...
        $check = $this->formNoStyle->checkbox('check', 1, true);
        ...
        $check = $this->formNoStyle->checkbox('check[key]', 'yes');
        ...
        $check1 = $this->formNoStyle->checkbox('multicheck[]', 1);
        $check2 = $this->formNoStyle->checkbox('multicheck[]', 2, true);
        $check3 = $this->formNoStyle->checkbox('multicheck[]', 3);
    ...
    public function testFormCheckboxWithModelRelation()
    {
        ...
        $check1 = $this->formNoStyle->checkbox('items[]', 1);
        $check2 = $this->formNoStyle->checkbox('items[]', 2);
        $check3 = $this->formNoStyle->checkbox('items[]', 3, false);
        $check4 = $this->formNoStyle->checkbox('items[]', 4, true);
    ...
    {
        $form1 = $this->formNoStyle->checkbox('foo');
        $form2 = $this->formNoStyle->checkbox('foo', 'foobar', true);
    ...
    {
        $form1 = $this->formNoStyle->input('radio', 'foo');
        $form2 = $this->formNoStyle->radio('foo');
        $form3 = $this->formNoStyle->radio('foo', 'foobar', true);
        $form4 = $this->formNoStyle->radio('foo', 'foobar', false, ['class' => 'span2']);
    ...
    public function testFormRadioRepopulation()
    {
        ...
        $radio1 = $this->formNoStyle->radio('radio', 1);
        $radio2 = $this->formNoStyle->radio('radio', 2, true);
    ...
    {
        $form1 = $this->formNoStyle->submit('foo');
        $form2 = $this->formNoStyle->submit('foo', ['class' => 'span2']);
    ...
    {
        $form1 = $this->formNoStyle->button('foo');
        $form2 = $this->formNoStyle->button('foo', ['class' => 'span2']);
    ...
    {
        $resetInput = $this->formNoStyle->reset('foo');
    ...
    public function testImageInput()
    {
        ...
        $image = $this->formNoStyle->image($url);
    ...
    protected function setModel(array $data, $object = true)
    {
        ...
        $this->formNoStyle->model($data, ['method' => 'GET']);
    }
*/
}
/*
